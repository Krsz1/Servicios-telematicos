...
## Prueba: ramp_3servidores

📅 **Fecha:** 2025-11-11 09:59:06
...
- **Tiempo de respuesta:** 108.1 ms promedio - Tiempos de respuesta rápidos y aceptables.
...
**Archivo JSON completo:** `ramp_3servers.json`

**Para ver el reporte HTML detallado, ejecuta:**
```bash
artillery report "/vagrant/reports/ramp_3servers.json" --output "/vagrant/reports/ramp_3servers.html"
```
