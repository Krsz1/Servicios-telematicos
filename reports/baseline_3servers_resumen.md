...
## Prueba: baseline_3servidores

📅 **Fecha:** 2025-11-11 09:58:24
...
| ⏰ **Errores ETIMEDOUT** | 0 |
| 🚀 **Tasa de peticiones promedio** | 45 req/seg |
...
**Archivo JSON completo:** `baseline_3servers.json`

**Para ver el reporte HTML detallado, ejecuta:**
```bash
artillery report "/vagrant/reports/baseline_3servers.json" --output "/vagrant/reports/baseline_3servers.html"
```
