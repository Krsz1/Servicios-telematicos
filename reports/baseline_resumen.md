...
| Métrica | Valor (ms) |
|---------|------------|
| 🕒 **Tiempo medio (mean)** | 157.4 |
| 💨 **Mediana (median)** | 6 |
| 📊 **Mínimo** | 0 |
| 📊 **Máximo** | 5043 |
| 🧭 **p95 (percentil 95)** | 13.1 |
| 🧭 **p99 (percentil 99)** | 4965.3 |
...
- **Tiempo de respuesta:** 157.4 ms promedio - Tiempos de respuesta rápidos y aceptables.
...
**Archivo JSON completo:** `baseline.json`
