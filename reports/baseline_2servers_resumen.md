...
## Prueba: baseline_2servidores

📅 **Fecha:** 2025-11-11 09:22:17
...
| Métrica | Valor (ms) |
|---------|------------|
| 🕒 **Tiempo medio (mean)** | 6.6 |
| 💨 **Mediana (median)** | 6 |
| 📊 **Mínimo** | 0 |
| 📊 **Máximo** | 73 |
| 🧭 **p95 (percentil 95)** | 10.1 |
| 🧭 **p99 (percentil 99)** | 16.9 |
...
- **Tiempo de respuesta:** 6.6 ms promedio - Tiempos de respuesta rápidos y aceptables.
...
**Archivo JSON completo:** `baseline_2servers.json`

**Para ver el reporte HTML detallado, ejecuta:**
```bash
artillery report "/vagrant/reports/baseline_2servers.json" --output "/vagrant/reports/baseline_2servers.html"
```
